...
(154, 'Uni Link', '', 'Uni Link', 'الفسبوك', 'Uni Link', 'Uni Link', 'Uni Link', 'Uni Link', 'Uni Link', 'Uni Link', 'Uni Link', 'Uni Link'),
...
(159, 'Uni Link_api', '', 'Uni Link API', 'فيسبوك API', 'Uni Link API', 'Uni Link API', 'Uni Link API', 'Uni Link API', 'Uni Link API', 'Uni Link API', 'Uni Link API', 'Uni Link API'),
...
CREATE TABLE `Wo_Pages` (
  ...
  `Uni Link` varchar(32) NOT NULL DEFAULT '',
...
CREATE TABLE `Wo_Posts` (
  ...
  `postUni Link` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE `Wo_Users` (
  ...
  `Uni Link` varchar(50) NOT NULL DEFAULT '',
...
ALTER TABLE `Wo_Posts`
  ...
  ADD KEY `postUni Link` (`postUni Link`),
